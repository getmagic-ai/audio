...
const navigation = [
  ...
  { name: "Team", href: "#", icon: HomeModernIcon, current: false },
  { name: "Projects", href: "#", icon: HomeModernIcon, current: false },
  { name: "Calendar", href: "#", icon: HomeModernIcon, current: false },
  { name: "Documents", href: "#", icon: HomeModernIcon, current: false },
  { name: "Reports", href: "#", icon: HomeModernIcon, current: false },
];
